...
export const FormUploadData = () => {
    ...
    return (
        <>
            <form onSubmit={handlePostSubmit} encType="multipart/form-data" className="text-center mb-20">
                <ComicDropZone />
                ...
                <button type="submit" className="mb-10 "><ButtonSubmit text={'投稿する'}/></button>
            </form>
            <ModalSeriesForm />
        </>
    )
